...
<div class="container">
    ...
    <div class="toast d-flex align-items-center" data-delay="500" data-autohide="false" role="alert" aria-live="assertive" aria-atomic="true">
      <div class="toast-body">
        <p>SELAMAT DATANG</p>{{ Auth::user()->name }}</br>
        {{ $waktu_sekarang }}
      </div>
    </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $total_saldo }}</div>
                </div>
              </div>
            </div>
            <div class="col-auto">
