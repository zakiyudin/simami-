...
<body>
    ...
    <h5 class="text-center">LAPORAN PEMASUKAN KEUANGAN</h5>
    <hr>
    <p>Kepada Yth :</p>
    <p>Bapak/Ibu/Saudara Donatur</p>
    <p>Bersama ini kami laporkan pemasukan keuangan masjid</p>
    ...
    <table class="tabel">
        ...
        <tbody>
            @foreach ($pemasukan as $pem)
                <tr>
                    <td>{{ $pem->tanggal_pemasukan }}</td>
                    <td>{{ $pem->uraian }}</td>
                    <td>Rp. {{ number_format($pem->nominal_pemasukan) }}</td>
